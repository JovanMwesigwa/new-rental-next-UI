...
const PropertyBedroomImagesUpload: React.FC<Props> = ({ moveOn, routeName }) => {


    return (
        <div className='w-1/2'>
            <div className="py-10">
                <h1 className="text-xl w-2/3 tracking-wide text-black font-semibold">Upload photos of your units front bedroom</h1>
...
export default PropertyBedroomImagesUpload;