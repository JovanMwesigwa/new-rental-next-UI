...
const UnitCard: React.FC<Props> = ({ active }) => {
    return (
        <div className={`flex h-24 flex-row p-2 w-full mt-4 ${active && "bg-red-50"} cursor-pointer hover:bg-red-50`}>
            <div className="h-full w-24 bg-gray-200 rounded-md p-2"></div>
            <div className="flex flex-1 flex-col px-3 flex-grow">
                ...
                <div className='flex flex-row items-center'>
                    ...
                    <h1 className='text-sm text-blue-600 mx-2'>UGX 0</h1>
                </div>
